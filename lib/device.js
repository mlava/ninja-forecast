...
/*var current_temp = '';  // Are these of any use?
 var current_time = '';  // or should they be currently_*
 var current_summary = ''; // Any way it seems to work without them.
 var current_icon = '';
...
function Device(snapshot_url,index,node,token,G) {
	...
	function precipIntensity() {
		...
		this.writeable = false;
		this.V = index;
		this.D = 22;  // Use the rainfall function. Not sure about units, maybe put back to 2000 ID
