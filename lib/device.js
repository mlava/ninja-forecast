	...
	process.nextTick(function() {
		updateDevices(snapshot_url, function() {
			...
			if (NF_temperatureMinTime == "yes") {
				self.devices.temperatureMinTime.emit('data',data.daily.data[0].temperatureMinTime);	
			}
			
			if (NF_temperatureMaxTime == "yes") {
				self.devices.temperatureMaxTime.emit('data',data.daily.data[0].temperatureMaxTime);	
			}
			
			if (NF_tmwTemperatureMaxTime == "yes") {
				self.devices.tmwTemperatureMaxTime.emit('data',data.daily.data[1].temperatureMaxTime);	
			}
			...
			if (NF_tmwPrecipIntensityMaxTime == "yes") {
				self.devices.tmwPrecipIntensityMaxTime.emit('data',data.daily.data[1].precipIntensityMaxTime);	
			}
			...
			if (NF_apparentTemperatureMaxTime == "yes") {
				self.devices.apparentTemperatureMaxTime.emit('data',data.daily.data[0].apparentTemperatureMaxTime);	
			}
			...
			if (NF_apparentTemperatureMinTime == "yes") {
				self.devices.apparentTemperatureMinTime.emit('data',data.daily.data[1].apparentTemperatureMinTime);	
			}
		});
