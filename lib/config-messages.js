...
exports.fetchIpModal = {
  "contents":[
	...
	{ "type":"input_field_select", "field_name": "nearestStormDistance", "label": "Nearest storm distance", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "nearestStormBearing", "label": "Nearest storm bearing", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"paragraph", "text":""},
	{ "type":"paragraph", "text":"Next hour:"},
	{ "type":"input_field_select", "field_name": "nextHourTemperature", "label": "Temperature", "options": [{ "name": "Yes", "value": "yes", "selected": true},{ "name": "No", "value": "no", "selected": false}], "required": true },
	{ "type":"input_field_select", "field_name": "nextHourApparentTemperature", "label": "Apparent Temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "nextHourPrecipProbability", "label": "Precipitation Probability", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "nextHourPrecipIntensity", "label": "Precipitation Intensity", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"paragraph", "text":""},
	...
	{ "type":"input_field_select", "field_name": "tonightTemperatureMin", "label": "Overnight minimum temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "temperatureMinTime", "label": "Overnight minimum temperature time", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "apparentTemperatureMin", "label": "Overnight minimum apparent temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "apparentTemperatureMinTime", "label": "Overnight minimum apparent temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "todayTemperatureMax", "label": "Today's maximum temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "temperatureMaxTime", "label": "Today's maximum temperature time", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "apparentTemperatureMax", "label": "Today's maximum apparent temperature", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "apparentTemperatureMaxTime", "label": "Today's maximum apparent temperature time", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	...
	{ "type":"input_field_select", "field_name": "tmwTemperatureMaxTime", "label": "Tomorrow's maximum time", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	...
	{ "type":"input_field_select", "field_name": "tmwPrecipIntensityMax", "label": "Precipitation intensity maximum", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"input_field_select", "field_name": "tmwPrecipIntensityMaxTime", "label": "Precipitation intensity maximum time", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	...
	{ "type":"input_field_select", "field_name": "moonPhase", "label": "Moon phase", "options": [{ "name": "Yes", "value": "yes", "selected": false},{ "name": "No", "value": "no", "selected": true}], "required": true },
	{ "type":"paragraph", "text":""},
